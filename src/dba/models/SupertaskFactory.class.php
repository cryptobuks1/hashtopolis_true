...
class SupertaskFactory extends AbstractModelFactory {
  ...
  function createObjectFromDict($pk, $dict) {
    $o = new Supertask($dict['supertaskId'], $dict['supertaskName'], $dict['priority'], $dict['sbis_count'], $dict['status'], $dict['percent'], $dict['create_time'],
        $dict['finish_time'], $dict['result']);
    return $o;
  }
